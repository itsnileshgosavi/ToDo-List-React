  ...
  return (
    <div className="flex justify-center items-center space-x-3 my-3">
       {/* Conditionally rendering the completed icon and  input field based on the completed state */}
        ...
        {edit? <input className="w-56 text-2xl bg-slate-200 rounded-xl p-2" type="text" onChange={(e) => {setTodoState(e.target.value)}}  value={todoState} /> :<p className="w-56 text-md md:text-2xl">{todoState}</p>}
